...
- [x] **Step 1: Extend tests for generator behavior**
...
- [x] **Step 2: Run generator tests and confirm RED**

Run: `zsh scripts/tests/agent-handoff-tests.sh`

Expected: nonzero exit because `scripts/new-agent-handoff.sh` does not exist.

- [x] **Step 3: Write protocol docs and generator**
...
- [x] **Step 4: Run tests and validator**
...
- [x] **Step 1: Add command integration**
...
- [x] **Step 2: Add mandatory start/end duties**
...
- [x] **Step 3: Link human workflow surfaces**
...
- [x] **Step 1: Fill factual handoff evidence**
